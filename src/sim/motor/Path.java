...
public class Path
{
    ...
    Spline constStep(int Q, double delta)
    {
        ...
        double eps=len/Q;
        Log.println("Length of curve:"+len+" eps:"+eps);
        if (eps/delta < 10)
        {
            Log.println("Warning you may have precision errors. Reduce delta in call to constStep");
        }
        ...
        Log.println("Asked "+Q+" points for interpolation, got "+k+" points");
    ...
    public double length(double delta)
    {
        ...
        var/=k;
        Log.println("Mean steplen:"+mean+" var:"+var);
